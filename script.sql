...
VALUES 	
        ...
        ('mohamedragab@aucegypt.edu', 
		'Qalyub', 'Egypt', 
        'Mohamed', 'Ragab', 'Abbas', 
        'M', '2002-1-15', 'Egyptian', '01245589723', 
        'Bachelor''s Degree', 1, 3.92),
        
        ('youssefmansour@aucegypt.edu', 
		'Giza', 'Egypt', 
        'Youssef', 'Ahmed', 'Mansour', 
        'M', '2003-4-4', 'Egyptian', '01245788932', 
        'Bachelor''s Degree', 1, 3.94),
...
VALUES
		...
		('mohamedragab@aucegypt.edu', 'English'),
		('mohamedragab@aucegypt.edu', 'Arabic'),

		('youssefmansour@aucegypt.edu', 'English'),
		('youssefmansour@aucegypt.edu', 'Arabic'),
...
VALUES
		...
		('mohamedragab@aucegypt.edu', 'Natural Language Processing'),
		('mohamedragab@aucegypt.edu', 'Data Visualization'),
        
		('youssefmansour@aucegypt.edu', 'Artificial Intelligence'),
		('youssefmansour@aucegypt.edu', 'Neural Networks'),
